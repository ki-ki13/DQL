...
class Agent:
    def __init__(self):
        ...
        self.model = layer_Qnet(11,256,3)
        self.trainer = Trainer(self.model, LEARNING_RATE=LR,gamma=self.gamma)
...
def train():
    ...
    while True:
        ...
        if done:
            ...
            print('Game', agent.n_games, 'Score',score, 'Record', record, 'Loss',loss)

            
            loss_set.append(loss)
            n_games_set.append(agent.n_games)

            plot(n_games_set, loss_set)
